...
```{r}
#storms_to_remove <- c("Dense Smoke", "Dust Devil", "Seiche")

#df_2019 <- df_2019[!df_2019$EVENT_TYPE %in% storms_to_remove, ]
#df_2022 <- df_2022[!df_2022$EVENT_TYPE %in% storms_to_remove, ]
```
...
# Now all data frames contain only the common event types and are ready for merging.
...
# Assuming storm_freq is your data frame with columns: EVENT_TYPE, freq_2019, freq_2021, freq_2022, freq_2023, freq_2024
...
```
```{r}
# Assuming storm_freq_long has columns: event_type, Year, Frequency
